...
const MobileSignUpStep1 = ({ email, setEmail, password, setPassword, emailError, setEmailError, passwordError, setPasswordError, checkPassword, setCheckPassword, checkPasswordError, setCheckPasswordError }) => {
...
export default MobileSignUpStep1;