...
const SignUpStep2 = ({ nickName, setNickName, department, setDepartment, studentNumber, setStudentNumber, userCategory, setUserCategory, nickNameError, setNickNameError, departmentError, setDepartmentError, studentNumberError, setStudentNumberError, }) => {
  ...
  return (
    <Container>
      ...
      <SignUpTextField
        ...
        disabled
      />
      <FormControl style={{ marginTop: 20, width: 320, minWidth: 80, marginBottom: 20 }} sx={customStyles}>
      ...
      <FormGroup style={{ width: '320px', display: 'flex', flexDirection: 'row', justifyContent: 'center', margin: '10px' }}>
...
const Department = ({ selectCollege, department, setDepartment }) => {
  ...
  return (
    <FormControl style={{ marginTop: 20, width: 320, minWidth: 80, marginBottom: 20 }} sx={customStyles} disabled={!isCollegeSelected}>
