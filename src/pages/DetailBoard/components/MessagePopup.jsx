...
const MessagePopup = ({ setIsClickedSendBtn, opponentId }) => {
  ...
  return (
    <PopupOverlay>
      <PopupContainer onSubmit={sendMessageSbumit}>
        ...
        />
        <BtnBox>
          <OrangeBorderButton onClick={() => setIsClickedSendBtn(false)} style={{width: 190}}>취소</OrangeBorderButton>
          <OrangeFilledButton type="submit" style={{width: 190}}>전송</OrangeFilledButton>
        </BtnBox>
      </PopupContainer>
    </PopupOverlay>
  )
